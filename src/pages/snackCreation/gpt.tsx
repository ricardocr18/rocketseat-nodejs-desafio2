...
import { SnackPositive } from "../snackCreation/components/snackPositive";
...
export function SnackCreation() {
  ...
  const [isPositiveSnack, setIsPositiveSnack] = useState<boolean | null>(null);

  const marcarDentroDaDieta = () => setDentroDaDieta(true);
  const marcarForaDaDieta = () => setDentroDaDieta(false);
